...
export function LoadingScreen(props) {
    ...
    useEffect(() => {
        ...
        switch (props.LS) {
            case true:{
            P1.current.animate(leftToRight,
                {
                    duration: 200,
                    iterations: 1,
                    fill: 'both',
            ...
            P2.current.animate(rightToLeft,
                {
                    duration: 200,
                    iterations: 1,
                    fill: 'both',
            ...
            P3.current.animate(leftToRight,
                {
                    duration: 200,
                    iterations: 1,
                    fill: 'both',
                ...
                break;
            case false: P1.current.animate(leftToRight,
                {
                    duration: 200,
                    iterations: 1,
                    fill: 'both',
